...
resdesc = [null,
    ...
    "[3x20] Increase the maximum number of [Diamond-] completions by 5 per level.",
    ...
    "[6x7] Unite a couple other ants towards your side as well, giving +2 free ant levels per level.",
    ...
    "[6x15] The first of a Pentalogy, this tome reduces the base requirements of Challenge 10 by dividing it by 1e100M! A must-read!",
    ...
    "[7x2] Wow! Industries sponsors another +0.9% per level towards your Ascension bank!",
    "[7x3] Hey, I totally didn't steal this idea. For each level, you gain 12 blessings of Wow! Cube tier for every Tesseract opened.",
    "[7x4] Make all Tesseract buildings produce 3% faster per level. Hey, isn't that more than the last research tier?",
    "[7x5] Tome 2 of 5: How to win over the Ant universe. Another e100M Divider to Challenge 10 Base Requirement on purchase.",
    ...
    "[7x14] +8% Spirit Power / level",
    "[7x15] Gain 2x the Spirit buffs in challenges!",
    "[7x16] +0.9% faster ticks / level",
    "[7x17] +0.8% cubes in Ascension Bank / level",
    "[7x18] +0.08% blessings / level",
    "[7x19] +4% faster Tesseract Buildings / level",
    "[7x20] Tome 3 of 4: e100M Divider!",
    "[7x21] +0.4% Accelerators / level",
    "[7x22] +0.4% Accelerator Boosts / level",
    "[7x23] +0.4% Multipliers / level",
    ...
    "[8x1] +0.2% Rune Effectiveness / level",
    "[8x2] +Log10(Crumbs)% to ant production per level",
    "[8x3] +666 Base ELO per level!",
    "[8x4] +0.04% more offerings per level per midas level!",
    "[8x5] +1 Export Quark per hour, yet again. [Can be leveled twice!]",
    ...
    "[8x12] +0.2% Accelerator Boosts / level",
    "[8x13] +0.2% Multipliers / level",
    ...
    "[8x16] +0.1% Rune Effectiveness / level",
    "[8x17] Each purchased level of Mortuus also increases Ascension Cube reward by +0.03%",
    "[8x18] +1% Ant Sacrifice Reward per level",
