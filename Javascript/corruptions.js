function corruptionDisplay(index){
    ...
    switch(index){
        case 1:
            ...
            c.textContent = "On this Ascension, this corruption is level " + format(player.usedCorruptions[1]) + ". Effect: Free Multiplier Exponent ^" + format(divisivenessPower[player.usedCorruptions[1]],3)
