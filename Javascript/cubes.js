...
function(){return "Raise building power to the power of (1 + level * 0.05)."},
...
function(){return "Yep. +0.1 Exponent per level to crystals."},
function(){return "Quantum tunnelling ftw. +0.4% global game speed per level."},
...
function(){return "Raise building power to (1 + 0.05 * Level) once more."},
