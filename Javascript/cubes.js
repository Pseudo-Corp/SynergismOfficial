...
const cubeUpgradeDescriptions = [null,
    () => "You got it! +14% cubes from Ascending per level.",
    ...
    () => "You got it again! +7% cubes from Ascending per level.",
    () => "Raise building power to the power of (1 + level * 0.09).",
    ...
    () => "You got it once more! +7% cubes from Ascending per level.",
    ...
    () => "You again? +7% cubes from Ascending per level.",
    ...
    () => "Yeah yeah yeah, +7% cubes from Ascending per level. Isn't it enough?",
