...
const cubeUpgradeName = [null,
    ...
    () => "Wow! I want opened cubes to give more boons 1.",
    () => "Wow! I want Iris Boon bonuses to scale better 1.",
    () => "Wow! I want Ares Boon bonuses to scale better 1.",
    ...
    () => "Wow! I want opened cubes to give more boons 2.",
    () => "Wow! I want Plutus Boon bonuses to scale better 1",
    () => "Wow! I want Moloch Boon bonuses to scale better 1",
    ...
    () => "Wow! I want opened cubes to give more boons 3.",
    () => "Wow! I want Chronos Boon bonuses to scale better 1",
    () => "Wow! I want Aphrodite Boon bonuses to scale better 1",
    ...
    () => "Wow! I want Athena Boon bonuses to scale better 1.",
    () => "Wow! I want more cubes 5.",
    () => "Wow! I want some Uncorruptable Obtainium.",
    () => "Wow! I want even more Uncorruptable Obtainium!",
    () => "Wow! I want Midas Boon bonus to scale better 1.",
    () => "Wow! I want Hermes Boon bonus to scale better 1.",
...
const cubeUpgradeDescriptions = [null,
    ...
    () => "[2x3] For each 20 cubes opened at once, you get 1 additional boon at random.",
    () => "[2x4] Iris shines her light on you. The effect power is now increased by +0.01 (+0.005 if >1000 boons) per level.",
    () => "[2x5] Ares teaches you the art of war. The effect power is now increased by +0.01 (+0.0033 if >1000 boons) per level.",
    ...
    () => "[3x3] For each 20 cubes opened at once, you get 1 additional boon at random.",
    () => "[3x4] Plutus teaches you the Art of the Deal. The effect power is now increased by +0.01 (+0.0033 if >1000 boons) per level.",
    () => "[3x5] Moloch lends you a hand in communicating with Ant God. The effect power is now increased by +0.01 (+0.0033 if >1000 boons) per level.",
    ...
    () => "[4x3] For each 20 cubes opened at once, you get yet another additional boon at random.",
