...
const cubeUpgradeDescriptions = [null,
    ...
    () => "You keep those 5 useful automation upgrades in the upgrade tab!",
    () => "You keep the mythos upgrade automation upgrade in the upgrade tab!",
    ...
    () => "Unlocks new coin upgrades ranging from start of ascend to post c10 and beyond. [NOT IMPLEMENTED YET]",
    ...
    () => "Whenever you open a cube, Aphrodite grazes it with a secondary blessing.",
