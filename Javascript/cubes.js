...
const cubeUpgradeDescriptions = [null,
    ...
    function () {return "You keep those 5 useful automation upgrades in the upgrades tab!"},
    function () {return "You keep the mythos upgrade automation upgrade in the upgrades tab!"},
    ...
    function () {return "Whenever you open a cube, Aphrodite graces it with a secondary blessing."},
