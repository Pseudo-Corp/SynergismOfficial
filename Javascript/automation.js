...
function autoUpgrades() {
	...
	if (player.upgrades[92] > 0.5){
        ...
        if(player.prestigePoints.greaterThanOrEqualTo(Decimal.pow(10, 50000)) && player.shoptoggles.prestige == true && (player.challengecompletions.seven > 0 || player.ascensionCount > 0)){buyUpgrades('prestige',38,true)}
        if(player.prestigePoints.greaterThanOrEqualTo(Decimal.pow(10, 100000)) && player.shoptoggles.prestige == true && (player.challengecompletions.eight > 0 || player.ascensionCount > 0)){buyUpgrades('prestige',39,true)}
        if(player.prestigePoints.greaterThanOrEqualTo(Decimal.pow(10, 200000)) && player.shoptoggles.prestige == true && (player.challengecompletions.nine > 0 || player.ascensionCount > 0)){buyUpgrades('prestige',40,true)}
