...
function calculateAnts() {
    ...
    if(player.currentChallenge.ascension === 11){c11bonus = Math.floor((15 * player.challengecompletions[8] + 15 * player.challengecompletions[9]) * (1 - player.challengecompletions[11]/10));}
