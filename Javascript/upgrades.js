let upgdesc = {
    ...
    upgdesc78: "Gain an ant speed multiplier equivalent to (1 + 0.01 * (log10(offerings + 1))^2).",
...
const upgradetexts = [null,
    ...
    () => "Gain +1% per Booster that the server has, up until 20!",
    () => "Gain +2% per Booster that the server has, up until 30!",
    () => "Every boost after 30 increases this reward by +1%, up until 50!",
    ...
    () => "Contracted time makes your game timers run " + format(1/2 * Math.log(player.researchPoints + 1)/Math.log(10),2,true) + "% more quickly.",
    ...
    () => "Epic 5x Ants!",
    () => "Ant Speed Multiplier: x" + format((Decimal.pow(1.005 + 5 / 100000 * player.researches[96], player.firstOwnedAnts + player.secondOwnedAnts + player.thirdOwnedAnts + player.fourthOwnedAnts + player.fifthOwnedAnts + player.sixthOwnedAnts + player.seventhOwnedAnts + player.eighthOwnedAnts)), 3),
    () => "Ant Speed Multiplier: x" + format(1 + 0.01 * Math.pow(Math.log(player.runeshards + 1)/Math.log(10),2),2,true),
