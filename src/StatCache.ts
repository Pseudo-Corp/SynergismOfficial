  ...
  updateVal(key: AmbrosialLuck, init = false): void {
    ...
    switch (key) {
      ...
      case "BlueberryUpgrade1": {
        this.vals[key] =
          +player.blueberryUpgrades.ambrosiaLuck1.bonus.ambrosiaLuck;
        break;
      }
      case "BlueberryUpgrade2": {
        this.vals[key] =
          +player.blueberryUpgrades.ambrosiaLuck2.bonus.ambrosiaLuck;
        break;
      }
      case "BlueberryCubeLuck1": {
        this.vals[key] =
          +player.blueberryUpgrades.ambrosiaCubeLuck1.bonus.ambrosiaLuck;
        break;
      }
      case "BlueberryQuarkLuck1": {
        this.vals[key] =
          +player.blueberryUpgrades.ambrosiaQuarkLuck1.bonus.ambrosiaLuck;
        break;
      }
  ...
  updateVal(key: BlueberryInventory, init = false): void {
    ...
    switch (key) {
      ...
      case "SingularityUpgrade": {
        this.vals[key] =
          +player.singularityUpgrades.blueberries.getEffect().bonus;
        break;
      }
      case "SingularityPerk": {
