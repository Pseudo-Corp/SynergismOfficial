...
export const areward = (i: number): string => {
    ...
    const descs: {[key: number]: string} = {
        ...
        189: `Gain 20% of excess time after 10 seconds each Ascension as a linear multiplier to ascensions (max 24 hours). Also: Cubes +${format(Math.min(200, player.ascensionCount / 2.5e6), 2)}% [Max: 200% at 500M Ascensions]`,
        193: `Gain ${format(Decimal.log(player.ascendShards.add(1), 10) / 4, 2)}% more Cubes on ascension!`,
        195: `Gain ${format(Decimal.log(player.ascendShards.add(1), 10) / 4, 2)}% more Cubes and Tesseracts on ascension! Multiplicative with the other Ach. bonus.`,
        196: `Gain ${format(Decimal.log(player.ascendShards.add(1), 10) / 50, 2)}% more Platonic Cubes on ascension!`,
        ...
        202: `Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Also: Tesseracts +${format(Math.min(200, player.ascensionCount / 5e6), 2)}% [Max: 200% at 1B Ascensions]`,
        ...
        209: "Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours).",
        ...
        216: `Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Also: Hypercubes +${format(Math.min(200, player.ascensionCount / 1e7), 2)}% [Max: 200% at 2B Ascensions]`,
        ...
        223: `Gain 20% of excess time after 10 seconds each Ascensions as a linear multiplier to ascensions (max 24 hours). Also: Platonic Cubes +${format(Math.min(200, player.ascensionCount / 13370000), 2)}% [Max: 200% at 2.674B Ascensions]`,
        ...
        254: `Cube Gain +${format(Math.min(15, Math.log10(corr[3]+1)), 2)}% [Max: +15% at 1e15 Ascension Score]`,
        255: `Tesseract Gain +${format(Math.min(15, Math.log10(corr[3]+1)), 2)}% [Max: +15% at 1e15 Ascension Score]`,
        256: `Hypercube Gain +${format(Math.min(15, Math.log10(corr[3]+1)), 2)}% [Max: +15% at 1e15 Ascension Score]`,
        257: `Platonic Gain +${format(Math.min(15, Math.log10(corr[3]+1)), 2)}% [Max: +15% at 1e15 Ascension Score]`,
        258: `Hepteract Gain +${format(Math.min(15, Math.log10(corr[3]+1)), 2)}% [Max: +15% at 1e15 Ascension Score]`,
        259: "Ascensions are 25% faster, forever!",
        260: "You will gain 25% more ascension count, forever!",
        261: "You will gain 25% more ascension count, forever!",
        ...
        264: `Hepteracts +${format(Math.min(40, player.ascensionCount / 5e8), 2)}% [Max: 40% at 20B Ascensions]!`,
        265: `Hepteracts +${format(Math.min(20, player.ascensionCount / 2.5e9), 2)}% [Max: 20% at 50B Ascensions]!`,
        266: `Quarks +${format(Math.min(10, player.ascensionCount / 1e10), 2)}% [Max: 10% at 100B Ascensions]!`,
