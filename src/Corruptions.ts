    ...
    const corruptionTexts: Record<'name' | 'description' | 'current' | 'planned' | 'multiplier' | 'spiritContribution' | 'image', string>[] = [
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptViscocity.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptSpatialDilation.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptHyperchallenged.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptScientificIlliteracy.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptDeflation.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptExtinction.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptDrought.png'
        },
        {
            ...
            image: 'Pictures/' + player.iconSet + '/CorruptFinancialCollapse.png'
        },
        {
            ...
            spiritContribution: '',
            image: 'Pictures/' + player.iconSet + '/CorruptExit.png'
        }
    ];
