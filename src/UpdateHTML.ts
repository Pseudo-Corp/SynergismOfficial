...
export const revealStuff = () => {
    ...
    for (let i = 0; i < example6.length; i++) {
        example6[i].style.display = player.unlocks.generation ? '' : 'none';
    }
    ...
    for (let i = 0; i < example7.length; i++) {
        example7[i].style.display = player.unlocks.transcend ? '' : 'none';
    }
    ...
    for (let i = 0; i < example8.length; i++) {
        example8[i].style.display = player.unlocks.reincarnate ? '' : 'none';
    }
    ...
    for (let i = 0; i < example26.length; i++) {
        example26[i].style.display = player.ascensionCount > 0 ? '' : 'none';
    }
    ...
    for (let i = 0; i < example27.length; i++) {
        example27[i].style.display = player.unlocks.prestige ? '' : 'none';
    }
    ...
    for (let i = 0; i < example28.length; i++) {
        example28[i].style.display = player.researches[150] > 0 ? '' : 'none';
    }
    ...
    for (let i = 0; i < example30.length; i++) {
        example30[i].style.display = player.cubeUpgrades[19] > 0 ? '' : 'none';
    }
