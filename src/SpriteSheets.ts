...
export const spriteSheets: SpriteSheet[] = [
  ...
  },
  {
    ...
    columns: 5,
    aliases: [
      { elementName: 'noSingularityUpgrades', iconIndex: 15, displaySize: 58 },
      { elementName: 'oneChallengeCap', iconIndex: 16, displaySize: 58 },
      { elementName: 'limitedAscensions', iconIndex: 17, displaySize: 58 },
      { elementName: 'noQuarkUpgrades', iconIndex: 18, displaySize: 58 },
      { elementName: 'noOcteracts', iconIndex: 19, displaySize: 58 },
      { elementName: 'noAmbrosiaUpgrades', iconIndex: 20, displaySize: 58 },
      { elementName: 'limitedTime', iconIndex: 21, displaySize: 58 },
      { elementName: 'sadisticPrequel', iconIndex: 22, displaySize: 58 },
      { elementName: 'taxmanLastStand', iconIndex: 23, displaySize: 58 }
    ]
  },
  {
    name: 'CampaignIcons',
    elementNames: [
      ...
      'ninthCampaignIcon',
      'tenthCampaignIcon',
      'eleventhCampaignIcon',
      'twelfthCampaignIcon',
      'thirteenthCampaignIcon',
      'fourteenthCampaignIcon',
      'fifteenthCampaignIcon',
      'sixteenthCampaignIcon',
      'seventeenthCampaignIcon',
      'eighteenthCampaignIcon',
      'nineteenthCampaignIcon',
      'twentiethCampaignIcon',
      'twentyFirstCampaignIcon',
      'twentySecondCampaignIcon',
      'twentyThirdCampaignIcon',
      'twentyFourthCampaignIcon',
      'twentyFifthCampaignIcon',
      'twentySixthCampaignIcon',
      'twentySeventhCampaignIcon',
      'twentyEighthCampaignIcon',
      'twentyNinthCampaignIcon',
      'thirtiethCampaignIcon',
      'thirtyFirstCampaignIcon',
      'thirtySecondCampaignIcon',
      'thirtyThirdCampaignIcon',
      'thirtyFourthCampaignIcon',
      'thirtyFifthCampaignIcon',
      'thirtySixthCampaignIcon',
      'thirtySeventhCampaignIcon',
      'thirtyEighthCampaignIcon',
      'thirtyNinthCampaignIcon',
      'fortiethCampaignIcon',
      'fortyFirstCampaignIcon',
      'fortySecondCampaignIcon',
      'fortyThirdCampaignIcon',
      'fortyFourthCampaignIcon',
      'fortyFifthCampaignIcon',
      'fortySixthCampaignIcon',
      'fortySeventhCampaignIcon',
      'fortyEighthCampaignIcon',
      'fortyNinthCampaignIcon',
      'fiftiethCampaignIcon'
    ],
    iconSize: 48,
    rows: 5,
    columns: 10
  ...
  {
    name: 'CampaignTokenIcons',
    elementNames: [
      'sumCampaignTokenIcon',
      'tutorialCampaignTokenIcon',
      'cubeCampaignTokenIcon',
      'obtainiumCampaignTokenIcon',
      'offeringCampaignTokenIcon',
      'ascensionScoreCampaignTokenIcon',
      null,
      'quarkCampaignTokenIcon',
      'taxCampaignTokenIcon',
      'c15CampaignTokenIcon',
      'rune6CampaignTokenIcon',
      'goldenQuarkCampaignTokenIcon',
      'octeractCampaignTokenIcon',
      'ambrosiaLuckCampaignTokenIcon',
      'blueberrySpeedCampaignTokenIcon'
    ],
    iconSize: 48,
    rows: 1,
    columns: 15
