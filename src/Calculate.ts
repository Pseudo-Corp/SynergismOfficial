...
export const calculateTotalAcceleratorBoost = () => {
  ...
  G.totalAcceleratorBoost =
    (Math.floor(player.acceleratorBoostBought + G.freeAcceleratorBoost) * 100) /
    100;
};
...
export const calculateRuneExpToLevel = (
  ...
  lookupTableRuneExp ??= Array.from({ length: 40000 + 1 }, (_, i) =>
    lookupTableGen(i)
  );
  ...
  if (runeIndex === 6) {
    multiplier =
      Math.pow(1e25, runeLevel) * (player.highestSingularityCount + 1);
  }
...
export const calculateMaxRunes = (i: number) => {
  ...
  const increaseAll =
    20 * (player.cubeUpgrades[16] + player.cubeUpgrades[37]) +
  ...
  max =
    increaseMaxLevel[i]! > G.runeMaxLvl
      ? G.runeMaxLvl
...
export function calculateOfferings(
  ...
  if (
    ...
    b +=
      ...
      (1 + player.researches[85] / 200);
    b *=
      1 + Math.pow(Decimal.log(player.transcendShards.add(1), 10), 1 / 2) / 5;
  ...
  q *=
    1 + (1 / 100) * player.shopUpgrades.offeringEX2 * player.singularityCount;
...
export const calculateObtainium = () => {
  ...
  player.obtainiumpersecond =
    Math.min(1e300, G.obtainiumGain) / (0.1 + player.reincarnationcounter);
  ...
  if (player.highestSingularityCount < 7) {
    for (let i = 1; i <= 5; i++) {
      if (player.talismanOne[i] === 1) {
        G.talisman1Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[1 - 1]]! +
            positiveBonus) *
          player.talismanLevels[1 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman1Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[1 - 1]]! -
            negativeBonus) *
          player.talismanLevels[1 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
      ...
      if (player.talismanTwo[i] === 1) {
        G.talisman2Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[2 - 1]]! +
            positiveBonus) *
          player.talismanLevels[2 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman2Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[2 - 1]]! -
            negativeBonus) *
          player.talismanLevels[2 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
      ...
      if (player.talismanThree[i] === 1) {
        G.talisman3Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[3 - 1]]! +
            positiveBonus) *
          player.talismanLevels[3 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman3Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[3 - 1]]! -
            negativeBonus) *
          player.talismanLevels[3 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
      ...
      if (player.talismanFour[i] === 1) {
        G.talisman4Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[4 - 1]]! +
            positiveBonus) *
          player.talismanLevels[4 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman4Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[4 - 1]]! -
            negativeBonus) *
          player.talismanLevels[4 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
      ...
      if (player.talismanFive[i] === 1) {
        G.talisman5Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[5 - 1]]! +
            positiveBonus) *
          player.talismanLevels[5 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman5Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[5 - 1]]! -
            negativeBonus) *
          player.talismanLevels[5 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
      ...
      if (player.talismanSix[i] === 1) {
        G.talisman6Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[6 - 1]]! +
            positiveBonus) *
          player.talismanLevels[6 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman6Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[6 - 1]]! -
            negativeBonus) *
          player.talismanLevels[6 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
      ...
      if (player.talismanSeven[i] === 1) {
        G.talisman7Effect[i] =
          (G.talismanPositiveModifier[player.talismanRarity[7 - 1]]! +
            positiveBonus) *
          player.talismanLevels[7 - 1] *
          G.challenge15Rewards.talismanBonus;
      } else {
        G.talisman7Effect[i] =
          (G.talismanNegativeModifier[player.talismanRarity[7 - 1]]! -
            negativeBonus) *
          player.talismanLevels[7 - 1] *
          -1 *
          G.challenge15Rewards.talismanBonus;
...
export const calculateRuneBonuses = () => {
  ...
  for (let i = 1; i <= 5; i++) {
    if (G.runeBlessings[i] <= 1e30) {
      G.effectiveRuneBlessingPower[i] =
        (Math.pow(G.runeBlessings[i], 1 / 8) / 75) *
        G.challenge15Rewards.blessingBonus;
    } else if (G.runeBlessings[i] > 1e30) {
      G.effectiveRuneBlessingPower[i] =
        ((Math.pow(10, 5 / 2) * Math.pow(G.runeBlessings[i], 1 / 24)) / 75) *
        G.challenge15Rewards.blessingBonus;
    }

    if (G.runeSpirits[i] <= 1e25) {
      G.effectiveRuneSpiritPower[i] =
        (Math.pow(G.runeSpirits[i], 1 / 8) / 75) *
        G.challenge15Rewards.spiritBonus;
    } else if (G.runeSpirits[i] > 1e25) {
      G.effectiveRuneSpiritPower[i] =
        ((Math.pow(10, 25 / 12) * Math.pow(G.runeSpirits[i], 1 / 24)) / 75) *
        G.challenge15Rewards.spiritBonus;
    }
  }
};
...
const calculateAntSacrificeMultipliers = () => {
  ...
  G.upgradeMultiplier *=
    1 + (1 / 50) * CalcECC("reincarnation", player.challengecompletions[10]);
...
export const calculateOffline = async (forceTime = 0) => {
  ...
  player.offlinetick =
    player.offlinetick < 1.5e12 ? Date.now() : player.offlinetick;
...
export const calculateTotalOcteractCubeBonus = () => {
  ...
  if (player.totalWowOcteracts < 1000) {
    ...
    const power =
      2 + +player.singularityChallenges.noOcteracts.rewards.octeractPow;
...
export const calculateTimeAcceleration = () => {
  ...
  const corruptableTimeMult =
    productContents(preCorruptionArr) * corruptionArr[0]; // DR applies after base corruption.
  ...
  const timeMult =
    productContents(preCorruptionArr) *
...
export const calculateAscensionSpeedMultiplier = () => {
  ...
  const exponent =
    player.singularityUpgrades.singAscensionSpeed.level > 0
      ? baseMultiplier >= 1
        ? 1.03
        : 0.97
      : 1;
...
export const calculateQuarkMultiplier = () => {
  ...
  multiplier *=
    1 + 0.3 * +player.octeractUpgrades.octeractStarter.getEffect().bonus; // Oct Starter Pack
  ...
  multiplier *=
    1 + +player.singularityUpgrades.singQuarkImprover1.getEffect().bonus; // Doohickey
...
export const calculateGoldenQuarkMultiplier = (computeMultiplier = false) => {
  ...
  let bonus =
    player.singularityCount < 10 ? 200 - 10 * player.singularityCount : 0;
  if (player.singularityCount === 0) {
    bonus += 200;
  }
...
export const calculateSummationLinear = (
  ...
  const realCost =
    (baseCost * buyToLevel * (1 + buyToLevel)) / 2 - subtractCost;
...
export const calculateSummationNonLinear = (
  ...
  const alreadySpent =
    baseCost * (c * Math.pow(baseLevel, 2) + baseLevel * (1 - c));
  ...
  let totalCost =
    baseCost * (c * Math.pow(buyToLevel, 2) + buyToLevel * (1 - c)) -
    alreadySpent;
...
export const calculateAscensionScore = () => {
  ...
  let bonusLevel = player.singularityUpgrades.corruptionFifteen.getEffect()
    ...
    : 0;
  bonusLevel +=
    +player.singularityChallenges.oneChallengeCap.rewards.freeCorruptionLevel;
  ...
  const challengeScoreArrays3 = [
    0, 20, 30, 50, 100, 200, 250, 300, 400, 500, 750,
  ];
  const challengeScoreArrays4 = [
    0, 10000, 10000, 10000, 10000, 10000, 2000, 3000, 4000, 5000, 7500,
  ];
  ...
  let bonusVal = player.singularityUpgrades.advancedPack.getEffect().bonus
    ...
    : 0;
  bonusVal +=
    +player.singularityChallenges.oneChallengeCap.rewards.corrScoreIncrease;
  for (let i = 2; i < 10; i++) {
    const exponent =
      i === 2 && player.usedCorruptions[i] >= 10
        ? 1 +
...
export const CalcCorruptionStuff = () => {
  ...
  let hepteractGain =
    G.challenge15Rewards.hepteractUnlocked &&
...
export const calcAscensionCount = () => {
  ...
  if (player.challengecompletions[10] > 0 && player.achievements[197] === 1) {
    ...
    ascCount *=
      player.achievements[187] && Math.floor(effectiveScore) > 1e8
...
export const calculateRequiredBlueberryTime = () => {
  ...
  const timeThresholds = [
    5000, 25000, 75000, 250000, 500000, 1e6, 2e6, 4e6, 1e7, 2e7, 4e7, 1e8,
  ];
...
export const dailyResetCheck = () => {
  ...
  if (day.getTime() - 3600000 > player.dayCheck.getTime()) {
    ...
    if (player.challengecompletions[11] > 0) {
      DOMCacheGetOrSet("tesseractQuarksOpenRequirement").style.display =
        "block";
    }
    if (player.challengecompletions[13] > 0) {
      DOMCacheGetOrSet("hypercubeQuarksOpenRequirement").style.display =
        "block";
    }
    if (player.challengecompletions[14] > 0) {
      DOMCacheGetOrSet("platonicCubeQuarksOpenRequirement").style.display =
        "block";
    }
  }
};
...
export const forcedDailyReset = (rewards = false) => {
  ...
  if (rewards) {
    player.overfluxPowder +=
      player.overfluxOrbs * calculatePowderConversion().mult;
