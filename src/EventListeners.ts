...
export const generateEventHandlers = () => {
  ...
  // Offline Button
  DOMCacheGetOrSet("exitOffline").addEventListener("click", () =>
    exitOffline()
  );
  DOMCacheGetOrSet("offlineContainer").addEventListener("dblclick", () =>
    exitOffline()
  );
  // UPPER UI ELEMENTS
  // Prelude: Cube/Tesseract/Hypercube/Platonic display UIs (Onclicks)
  DOMCacheGetOrSet("ascCubeStats").addEventListener("click", () =>
    toggleAscStatPerSecond(1)
  );
  DOMCacheGetOrSet("ascTessStats").addEventListener("click", () =>
    toggleAscStatPerSecond(2)
  );
  DOMCacheGetOrSet("ascHyperStats").addEventListener("click", () =>
    toggleAscStatPerSecond(3)
  );
  DOMCacheGetOrSet("ascPlatonicStats").addEventListener("click", () =>
    toggleAscStatPerSecond(4)
  );
  DOMCacheGetOrSet("ascHepteractStats").addEventListener("click", () =>
    toggleAscStatPerSecond(5)
  );
  DOMCacheGetOrSet("ascTimeTakenStats").addEventListener("click", () =>
    toggleAscStatPerSecond(6)
  );
  // Part 1: Reset Tiers
  // Onmouseover Events
  DOMCacheGetOrSet("prestigebtn").addEventListener("mouseover", () =>
    resetrepeat("prestige")
  );
  DOMCacheGetOrSet("transcendbtn").addEventListener("mouseover", () =>
    resetrepeat("transcension")
  );
  DOMCacheGetOrSet("reincarnatebtn").addEventListener("mouseover", () =>
    resetrepeat("reincarnation")
  );
  DOMCacheGetOrSet("acceleratorboostbtn").addEventListener("mouseover", () =>
    resetrepeat("acceleratorBoost")
  );
  DOMCacheGetOrSet("challengebtn").addEventListener("mouseover", () =>
  ...
  DOMCacheGetOrSet("ascendChallengeBtn").addEventListener("mouseover", () =>
    resetrepeat("ascensionChallenge")
  );
  DOMCacheGetOrSet("ascendbtn").addEventListener("mouseover", () =>
    resetrepeat("ascension")
  );
  DOMCacheGetOrSet("singularitybtn").addEventListener("mouseover", () =>
    resetrepeat("singularity")
  );

  for (const resetButton of Array.from(
  ...
  DOMCacheGetOrSet("prestigebtn").addEventListener("click", () =>
    resetCheck("prestige")
  );
  DOMCacheGetOrSet("transcendbtn").addEventListener("click", () =>
    resetCheck("transcension")
  );
  DOMCacheGetOrSet("reincarnatebtn").addEventListener("click", () =>
    resetCheck("reincarnation")
  );
  DOMCacheGetOrSet("acceleratorboostbtn").addEventListener("click", () =>
    boostAccelerator()
  );
  DOMCacheGetOrSet("challengebtn").addEventListener("click", () =>
    resetCheck("transcensionChallenge", undefined, true)
  );
  DOMCacheGetOrSet("reincarnatechallengebtn").addEventListener("click", () =>
    resetCheck("reincarnationChallenge", undefined, true)
  );
  DOMCacheGetOrSet("ascendChallengeBtn").addEventListener("click", () =>
    resetCheck("ascensionChallenge")
  );
  DOMCacheGetOrSet("ascendbtn").addEventListener("click", () =>
    resetCheck("ascension")
  );
  DOMCacheGetOrSet("singularitybtn").addEventListener("click", () =>
    resetCheck("singularity")
  );
  ...
  DOMCacheGetOrSet("buyaccelerator").addEventListener("click", () =>
    buyAccelerator()
  );
  DOMCacheGetOrSet("buymultiplier").addEventListener("click", () =>
    buyMultiplier()
  );
  DOMCacheGetOrSet("buyacceleratorboost").addEventListener("click", () =>
    boostAccelerator()
  );
  ...
  DOMCacheGetOrSet("prestigeautotoggle").addEventListener("click", () =>
    toggleautoreset(1)
  );
  DOMCacheGetOrSet("transcendautotoggle").addEventListener("click", () =>
    toggleautoreset(2)
  );
  DOMCacheGetOrSet("reincarnateautotoggle").addEventListener("click", () =>
    toggleautoreset(3)
  );
  DOMCacheGetOrSet("tesseractautobuymode").addEventListener("click", () =>
    toggleautoreset(4)
  );
  // Toggles auto reset amount required to trigger
  DOMCacheGetOrSet("prestigeamount").addEventListener("blur", () =>
    updateAutoReset(1)
  );
  DOMCacheGetOrSet("transcendamount").addEventListener("blur", () =>
    updateAutoReset(2)
  );
  DOMCacheGetOrSet("reincarnationamount").addEventListener("blur", () =>
    updateAutoReset(3)
  );
  DOMCacheGetOrSet("ascensionAmount").addEventListener("blur", () =>
    updateAutoReset(4)
  );
  DOMCacheGetOrSet("autoAntSacrificeAmount").addEventListener("blur", () =>
    updateAutoReset(5)
  );
  // Tesseract-specific of the above. I don't know why I didn't standardize names here.
  DOMCacheGetOrSet("tesseractautobuytoggle").addEventListener("click", () =>
    toggleautobuytesseract()
  );
  DOMCacheGetOrSet("tesseractAmount").addEventListener("blur", () =>
    updateTesseractAutoBuyAmount()
  );
  // Auto Opening of Cubes
  DOMCacheGetOrSet("cubeOpensInput").addEventListener("blur", () =>
    updateAutoCubesOpens(1)
  );
  DOMCacheGetOrSet("tesseractsOpensInput").addEventListener("blur", () =>
    updateAutoCubesOpens(2)
  );
  DOMCacheGetOrSet("hypercubesOpensInput").addEventListener("blur", () =>
    updateAutoCubesOpens(3)
  );
  DOMCacheGetOrSet("platonicCubeOpensInput").addEventListener("blur", () =>
    updateAutoCubesOpens(4)
  );
  DOMCacheGetOrSet("openCubes").addEventListener("click", () =>
    toggleautoopensCubes(1)
  );
  DOMCacheGetOrSet("openTesseracts").addEventListener("click", () =>
    toggleautoopensCubes(2)
  );
  DOMCacheGetOrSet("openHypercubes").addEventListener("click", () =>
    toggleautoopensCubes(3)
  );
  DOMCacheGetOrSet("openPlatonicCube").addEventListener("click", () =>
    toggleautoopensCubes(4)
  );
  ...
  for (let index = 1; index <= 125; index++) {
    // Onmouseover events ()
    DOMCacheGetOrSet(`upg${index}`).addEventListener("mouseover", () =>
  ...
  for (let index = 1; index <= 125; index++) {
    DOMCacheGetOrSet(`upg${index}`).addEventListener("click", () =>
      clickUpgrades(index, false)
    );
  }

  for (let index = 1; index <= 6; index++) {
    DOMCacheGetOrSet(`upgrades${index}`).addEventListener("click", () =>
      categoryUpgrades(index, false)
    );
  }

  // Next part: Shop-specific toggles
  DOMCacheGetOrSet("coinAutoUpgrade").addEventListener("click", () =>
    toggleShops("coin")
  );
  DOMCacheGetOrSet("prestigeAutoUpgrade").addEventListener("click", () =>
    toggleShops("prestige")
  );
  DOMCacheGetOrSet("transcendAutoUpgrade").addEventListener("click", () =>
    toggleShops("transcend")
  );
  DOMCacheGetOrSet("generatorsAutoUpgrade").addEventListener("click", () =>
    toggleShops("generators")
  );
  DOMCacheGetOrSet("reincarnateAutoUpgrade").addEventListener("click", () =>
    toggleShops("reincarnate")
  );
  ...
  for (let index = 1; index <= achievementpointvalues.length - 1; index++) {
    ...
    DOMCacheGetOrSet(`ach${index}`).addEventListener("mouseover", () =>
  ...
  DOMCacheGetOrSet("toggleautosacrifice").addEventListener("click", () =>
  ...
  for (let index = 0; index < 7; index++) {
    DOMCacheGetOrSet(`rune${index + 1}`).addEventListener("mouseover", () =>
      displayRuneInformation(index + 1)
    );
    DOMCacheGetOrSet(`rune${index + 1}`).addEventListener("click", () =>
      toggleAutoSacrifice(index + 1)
    );
    ...
    DOMCacheGetOrSet(`activaterune${index + 1}`).addEventListener("click", () =>
      redeemShards(index + 1)
    );
  }
  ...
  DOMCacheGetOrSet("toggleautoBuyFragments").addEventListener("click", () =>
    toggleAutoBuyFragment()
  );
  DOMCacheGetOrSet("toggleautoenhance").addEventListener("click", () =>
    toggleautoenhance()
  );
  DOMCacheGetOrSet("toggleautofortify").addEventListener("click", () =>
    toggleautofortify()
  );
  ...
  DOMCacheGetOrSet("buyTalismanAll").addEventListener("mouseover", () =>
    updateTalismanCostDisplay(null)
  );
  DOMCacheGetOrSet("buyTalismanAll").addEventListener("click", () =>
    buyAllTalismanResources()
  );

  for (let index = 0; index < 7; index++) {
    DOMCacheGetOrSet(`talisman${index + 1}`).addEventListener("click", () =>
      showTalismanEffect(index)
    );
  ...
  DOMCacheGetOrSet("respecAllTalismans").addEventListener("click", () =>
    showRespecInformation(7)
  );
  DOMCacheGetOrSet("confirmTalismanRespec").addEventListener("click", () =>
    respecTalismanConfirm(G.talismanRespec)
  );
  DOMCacheGetOrSet("cancelTalismanRespec").addEventListener("click", () =>
    respecTalismanCancel(G.talismanRespec)
  );
  ...
  DOMCacheGetOrSet("buyRuneBlessingInput").addEventListener("blur", () =>
    updateRuneBlessingBuyAmount(1)
  );
  DOMCacheGetOrSet("buyRuneSpiritInput").addEventListener("blur", () =>
    updateRuneBlessingBuyAmount(2)
  );

  DOMCacheGetOrSet("buyAllBlessings").addEventListener("click", () =>
    buyAllBlessings("Blessings")
  );
  DOMCacheGetOrSet("buyAllSpirits").addEventListener("click", () =>
    buyAllBlessings("Spirits")
  );
  ...
  for (let index = 0; index < 15; index++) {
    DOMCacheGetOrSet(`challenge${index + 1}`).addEventListener("click", () =>
  ...
  DOMCacheGetOrSet("startChallenge").addEventListener("click", () =>
    toggleChallenges(G.triggerChallenge, false)
  );
  DOMCacheGetOrSet("retryChallenge").addEventListener("click", () =>
    toggleRetryChallenges()
  );
  // Autochallenge buttons
  DOMCacheGetOrSet("toggleAutoChallengeIgnore").addEventListener("click", () =>
    toggleAutoChallengesIgnore(G.triggerChallenge)
  );
  DOMCacheGetOrSet("toggleAutoChallengeStart").addEventListener("click", () =>
    toggleAutoChallengeRun()
  );
  ...
  for (let index = 1; index < 200; index++) {
    ...
    DOMCacheGetOrSet(`res${index}`).addEventListener("click", () =>
      buyResearch(index)
    );
    DOMCacheGetOrSet(`res${index}`).addEventListener("mouseover", () =>
      researchDescriptions(index)
    );
  }
  // Research 200 is special, uses more params
  DOMCacheGetOrSet("res200").addEventListener("click", () =>
    buyResearch(200, false, 0.01)
  );
  DOMCacheGetOrSet("res200").addEventListener("mouseover", () =>
    researchDescriptions(200, false, 0.01)
  );

  // Part 2: QoL buttons
  DOMCacheGetOrSet("toggleresearchbuy").addEventListener("click", () =>
    toggleResearchBuy()
  );
  DOMCacheGetOrSet("toggleautoresearch").addEventListener("click", () =>
    toggleAutoResearch()
  );
  DOMCacheGetOrSet("toggleautoresearchmode").addEventListener("click", () =>
    toggleAutoResearchMode()
  );
  ...
  for (let index = 1; index <= 8; index++) {
    // Onmouse Events
    DOMCacheGetOrSet(`anttier${index}`).addEventListener("mouseover", () =>
  ...
  for (let index = 1; index <= 12; index++) {
    // Onmouse Event
    DOMCacheGetOrSet(`antUpgrade${index}`).addEventListener("mouseover", () =>
      antUpgradeDescription(index)
    );
    // Onclick Event
    DOMCacheGetOrSet(`antUpgrade${index}`).addEventListener("click", () =>
      buyAntUpgrade(antUpgradeCostVals[index], false, index)
    );
  }
  // Part 3: Sacrifice
  DOMCacheGetOrSet("antSacrifice").addEventListener("click", () =>
    sacrificeAnts()
  );

  // Part 4: QoL Buttons
  DOMCacheGetOrSet("toggleAntMax").addEventListener("click", () =>
    toggleAntMaxBuy()
  );
  DOMCacheGetOrSet("toggleAutoSacrificeAnt").addEventListener("click", () =>
    toggleAntAutoSacrifice(0)
  );
  DOMCacheGetOrSet("autoSacrificeAntMode").addEventListener("click", () =>
  ...
  for (let index = 1; index < player.cubeUpgrades.length; index++) {
    DOMCacheGetOrSet(`cubeUpg${index}`).addEventListener("mouseover", () =>
      cubeUpgradeDesc(index)
    );
    DOMCacheGetOrSet(`cubeUpg${index}`).addEventListener("click", () =>
      buyCubeUpgrades(index)
    );
  }

  // Toggle
  DOMCacheGetOrSet("toggleCubeBuy").addEventListener("click", () =>
    toggleMaxBuyCube()
  );
  DOMCacheGetOrSet("toggleAutoCubeUpgrades").addEventListener("click", () =>
    autoCubeUpgradesToggle()
  );

  // Part 2: Cube Opening Buttons
  // Wow Cubes
  DOMCacheGetOrSet("open1Cube").addEventListener("click", () =>
    player.wowCubes.open(1, false)
  );
  DOMCacheGetOrSet("open20Cube").addEventListener("click", () =>
    player.wowCubes.open(Math.floor(Number(player.wowCubes) / 10), false)
  );
  DOMCacheGetOrSet("open1000Cube").addEventListener("click", () =>
    player.wowCubes.open(Math.floor(Number(player.wowCubes) / 2), false)
  );
  DOMCacheGetOrSet("openCustomCube").addEventListener("click", () =>
    player.wowCubes.openCustom()
  );
  DOMCacheGetOrSet("openMostCube").addEventListener("click", () =>
    player.wowCubes.open(0, true)
  );
  // Wow Tesseracts
  DOMCacheGetOrSet("open1Tesseract").addEventListener("click", () =>
    player.wowTesseracts.open(1, false)
  );
  ...
  DOMCacheGetOrSet("openCustomTesseract").addEventListener("click", () =>
    player.wowTesseracts.openCustom()
  );
  DOMCacheGetOrSet("openMostTesseract").addEventListener("click", () =>
    player.wowTesseracts.open(1, true)
  );
  // Wow Hypercubes
  DOMCacheGetOrSet("open1Hypercube").addEventListener("click", () =>
    player.wowHypercubes.open(1, false)
  );
  ...
  DOMCacheGetOrSet("openCustomHypercube").addEventListener("click", () =>
    player.wowHypercubes.openCustom()
  );
  DOMCacheGetOrSet("openMostHypercube").addEventListener("click", () =>
    player.wowHypercubes.open(1, true)
  );
  // Wow Platonic Cubes
  DOMCacheGetOrSet("open1PlatonicCube").addEventListener("click", () =>
    player.wowPlatonicCubes.open(1, false)
  );
  ...
  DOMCacheGetOrSet("openCustomPlatonicCube").addEventListener("click", () =>
    player.wowPlatonicCubes.openCustom()
  );
  DOMCacheGetOrSet("openMostPlatonicCube").addEventListener("click", () =>
    player.wowPlatonicCubes.open(1, true)
  );

  DOMCacheGetOrSet("saveOffToggle").addEventListener("click", () =>
    toggleSaveOff()
  );
  ...
  for (let index = 0; index < platonicUpgrades.length; index++) {
    platonicUpgrades[index].addEventListener("mouseover", () =>
      createPlatonicDescription(index + 1)
    );
    platonicUpgrades[index].addEventListener("click", () =>
      buyPlatonicUpgrades(index + 1)
    );
  }
  DOMCacheGetOrSet("toggleAutoPlatonicUpgrades").addEventListener("click", () =>
    autoPlatonicUpgradesToggle()
  );

  // Part 4: Hepteract Subtab
  DOMCacheGetOrSet("chronosHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("chronos")
  );
  DOMCacheGetOrSet("hyperrealismHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("hyperrealism")
  );
  DOMCacheGetOrSet("quarkHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("quark")
  );
  DOMCacheGetOrSet("challengeHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("challenge")
  );
  DOMCacheGetOrSet("abyssHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("abyss")
  );
  DOMCacheGetOrSet("acceleratorHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("accelerator")
  );
  DOMCacheGetOrSet("acceleratorBoostHepteract").addEventListener(
    "mouseover",
    () => hepteractDescriptions("acceleratorBoost")
  );
  DOMCacheGetOrSet("multiplierHepteract").addEventListener("mouseover", () =>
    hepteractDescriptions("multiplier")
  );

  DOMCacheGetOrSet("chronosHepteractCraft").addEventListener("click", () =>
    player.hepteractCrafts.chronos.craft()
  );
  DOMCacheGetOrSet("hyperrealismHepteractCraft").addEventListener("click", () =>
    player.hepteractCrafts.hyperrealism.craft()
  );
  DOMCacheGetOrSet("quarkHepteractCraft").addEventListener("click", () =>
    player.hepteractCrafts.quark.craft()
  );
  DOMCacheGetOrSet("challengeHepteractCraft").addEventListener("click", () =>
    player.hepteractCrafts.challenge.craft()
  );
  DOMCacheGetOrSet("abyssHepteractCraft").addEventListener("click", () =>
    player.hepteractCrafts.abyss.craft()
  );
  DOMCacheGetOrSet("acceleratorHepteractCraft").addEventListener("click", () =>
  ...
  DOMCacheGetOrSet("multiplierHepteractCraft").addEventListener("click", () =>
    player.hepteractCrafts.multiplier.craft()
  );

  DOMCacheGetOrSet("chronosHepteractCraftMax").addEventListener("click", () =>
  ...
  DOMCacheGetOrSet("quarkHepteractCraftMax").addEventListener("click", () =>
    player.hepteractCrafts.quark.craft(true)
  );
  DOMCacheGetOrSet("challengeHepteractCraftMax").addEventListener("click", () =>
    player.hepteractCrafts.challenge.craft(true)
  );
  DOMCacheGetOrSet("abyssHepteractCraftMax").addEventListener("click", () =>
    player.hepteractCrafts.abyss.craft(true)
  );
  ...
  DOMCacheGetOrSet("chronosHepteractCap").addEventListener("click", () =>
    player.hepteractCrafts.chronos.expand()
  );
  DOMCacheGetOrSet("hyperrealismHepteractCap").addEventListener("click", () =>
    player.hepteractCrafts.hyperrealism.expand()
  );
  DOMCacheGetOrSet("quarkHepteractCap").addEventListener("click", () =>
    player.hepteractCrafts.quark.expand()
  );
  DOMCacheGetOrSet("challengeHepteractCap").addEventListener("click", () =>
    player.hepteractCrafts.challenge.expand()
  );
  DOMCacheGetOrSet("abyssHepteractCap").addEventListener("click", () =>
    player.hepteractCrafts.abyss.expand()
  );
  DOMCacheGetOrSet("acceleratorHepteractCap").addEventListener("click", () =>
  ...
  DOMCacheGetOrSet("multiplierHepteractCap").addEventListener("click", () =>
    player.hepteractCrafts.multiplier.expand()
  );

  DOMCacheGetOrSet("chronosHepteractAuto").addEventListener("click", () =>
    player.hepteractCrafts.chronos.toggleAutomatic()
  );
  DOMCacheGetOrSet("hyperrealismHepteractAuto").addEventListener("click", () =>
    player.hepteractCrafts.hyperrealism.toggleAutomatic()
  );
  DOMCacheGetOrSet("quarkHepteractAuto").addEventListener("click", () =>
    player.hepteractCrafts.quark.toggleAutomatic()
  );
  DOMCacheGetOrSet("challengeHepteractAuto").addEventListener("click", () =>
    player.hepteractCrafts.challenge.toggleAutomatic()
  );
  DOMCacheGetOrSet("abyssHepteractAuto").addEventListener("click", () =>
    player.hepteractCrafts.abyss.toggleAutomatic()
  );
  DOMCacheGetOrSet("acceleratorHepteractAuto").addEventListener("click", () =>
  ...
  DOMCacheGetOrSet("multiplierHepteractAuto").addEventListener("click", () =>
    player.hepteractCrafts.multiplier.toggleAutomatic()
  );

  DOMCacheGetOrSet("hepteractToQuark").addEventListener("mouseover", () =>
    hepteractToOverfluxOrbDescription()
  );
  DOMCacheGetOrSet("hepteractToQuarkTrade").addEventListener("click", () =>
    tradeHepteractToOverfluxOrb()
  );
  DOMCacheGetOrSet("hepteractToQuarkTradeMax").addEventListener("click", () =>
    tradeHepteractToOverfluxOrb(true)
  );
  DOMCacheGetOrSet("hepteractToQuarkTradeAuto").addEventListener("click", () =>
    toggleAutoBuyOrbs()
  );
  DOMCacheGetOrSet("overfluxPowder").addEventListener("mouseover", () =>
    overfluxPowderDescription()
  );
  DOMCacheGetOrSet("powderDayWarp").addEventListener("click", () =>
    overfluxPowderWarp(false)
  );
  DOMCacheGetOrSet("warpAuto").addEventListener("click", () =>
    overfluxPowderWarp(true)
  );
  ...
  // CORRUPTION TAB
  // Part 0: Subtabs
  DOMCacheGetOrSet("corrStatsBtn").addEventListener("click", () =>
    changeSubTab(Tabs.Corruption, { page: 0 })
  );
  DOMCacheGetOrSet("corrLoadoutsBtn").addEventListener("click", () =>
    changeSubTab(Tabs.Corruption, { page: 1 })
  );

  // Part 1: Displays
  DOMCacheGetOrSet("corruptionDisplays").addEventListener("click", () =>
    corruptionDisplay(10)
  );
  DOMCacheGetOrSet("corruptionCleanse").addEventListener("click", () =>
    corruptionCleanseConfirm()
  );
  DOMCacheGetOrSet("corruptionCleanseConfirm").addEventListener("click", () =>
    toggleCorruptionLevel(10, 999)
  );

  // Extra toggle
  DOMCacheGetOrSet("ascensionAutoEnable").addEventListener("click", () =>
    toggleAutoAscend(0)
  );
  DOMCacheGetOrSet("ascensionAutoToggle").addEventListener("click", () =>
    toggleAutoAscend(1)
  );
  ...
  for (const subtab of settingSubTabs) {
    subtab.addEventListener("click", () =>
      changeSubTab(Tabs.Settings, { page: settingSubTabs.indexOf(subtab) })
    );
  }
  ...
  DOMCacheGetOrSet("summaryGeneration").addEventListener("click", () =>
    generateExportSummary()
  );

  // Various functions
  DOMCacheGetOrSet("exportgame").addEventListener("click", () =>
    exportSynergism()
  );
  DOMCacheGetOrSet("saveStringInput").addEventListener("blur", (e) =>
    updateSaveString(e.target as HTMLInputElement)
  );
  DOMCacheGetOrSet("savegame").addEventListener("click", () =>
    saveSynergy(true)
  );
  DOMCacheGetOrSet("deleteGame").addEventListener("click", () => resetGame());
  DOMCacheGetOrSet("preloadDeleteGame").addEventListener("click", () =>
    reloadDeleteGame()
  );
  DOMCacheGetOrSet("promocodes").addEventListener("click", () =>
    promocodesPrompt()
  );
  DOMCacheGetOrSet("addCodeBox").addEventListener("mouseover", () =>
    promocodesInfo("add")
  );
  DOMCacheGetOrSet("addCode").addEventListener("click", () =>
    promocodes("add")
  );
  DOMCacheGetOrSet("addCodeAll").addEventListener("click", () =>
    promocodes("add", addCodeAvailableUses())
  );
  DOMCacheGetOrSet("addCodeOne").addEventListener("click", () =>
    promocodes("add", 1)
  );
  DOMCacheGetOrSet("dailyCode").addEventListener("click", () =>
    promocodes("daily")
  );
  DOMCacheGetOrSet("dailyCode").addEventListener("mouseover", () =>
    promocodesInfo("daily")
  );
  DOMCacheGetOrSet("timeCode").addEventListener("click", () =>
    promocodes("time")
  );
  DOMCacheGetOrSet("timeCode").addEventListener("mouseover", () =>
    promocodesInfo("time")
  );
  ...
  DOMCacheGetOrSet("resetHotkeys").addEventListener("click", () =>
    resetHotkeys()
  );
  DOMCacheGetOrSet("notation").addEventListener("click", () =>
    toggleAnnotation()
  );
  DOMCacheGetOrSet("iconSet").addEventListener("click", () =>
    toggleIconSet(player.iconSet + 1)
  );
...
TODO: Fix this entire tab it's utter shit
  ...
  */
  ...
  // Part 2: Potions
  /*Offering Potion*/
  DOMCacheGetOrSet("offeringPotions").addEventListener("mouseover", () =>
    shopDescriptions("offeringPotion")
  );
  DOMCacheGetOrSet("offeringpotionowned").addEventListener("mouseover", () =>
    shopDescriptions("offeringPotion")
  );
  DOMCacheGetOrSet("buyofferingpotion").addEventListener("mouseover", () =>
    shopDescriptions("offeringPotion")
  );
  DOMCacheGetOrSet("useofferingpotion").addEventListener("mouseover", () =>
    shopDescriptions("offeringPotion")
  );
  DOMCacheGetOrSet("buyofferingpotion").addEventListener("click", () =>
    buyShopUpgrades("offeringPotion")
  );
  ...
  DOMCacheGetOrSet("useofferingpotion").addEventListener("click", () =>
    useConsumable("offeringPotion")
  );
  DOMCacheGetOrSet("toggle42").addEventListener("click", () => {
    player.autoPotionTimer = 0;
  });
  /*Obtainium Potion*/
  DOMCacheGetOrSet("obtainiumPotions").addEventListener("mouseover", () =>
    shopDescriptions("obtainiumPotion")
  );
  DOMCacheGetOrSet("obtainiumpotionowned").addEventListener("mouseover", () =>
    shopDescriptions("obtainiumPotion")
  );
  DOMCacheGetOrSet("buyobtainiumpotion").addEventListener("mouseover", () =>
    shopDescriptions("obtainiumPotion")
  );
  DOMCacheGetOrSet("useobtainiumpotion").addEventListener("mouseover", () =>
    shopDescriptions("obtainiumPotion")
  );
  DOMCacheGetOrSet("buyobtainiumpotion").addEventListener("click", () =>
    buyShopUpgrades("obtainiumPotion")
  );
  ...
  DOMCacheGetOrSet("useobtainiumpotion").addEventListener("click", () =>
    useConsumable("obtainiumPotion")
  );
  ...
  for (const key of shopKeys) {
    ...
    if (shopItem.type === shopUpgradeTypes.UPGRADE) {
      DOMCacheGetOrSet(`${key}`).addEventListener("mouseover", () =>
        shopDescriptions(key)
      );
      DOMCacheGetOrSet(`${key}Level`).addEventListener("mouseover", () =>
        shopDescriptions(key)
      );
      DOMCacheGetOrSet(`${key}Button`).addEventListener("mouseover", () =>
        shopDescriptions(key)
      );
      // DOMCacheGetOrSet(`${key}`).addEventListener('click', () => buyShopUpgrades(key))  //Allow clicking of image to buy also
      DOMCacheGetOrSet(`${key}Button`).addEventListener("click", () =>
        buyShopUpgrades(key)
      );
    }
  }
  DOMCacheGetOrSet("buySingularityQuarksButton").addEventListener("click", () =>
    buyGoldenQuarks()
  );
  // SINGULARITY TAB
  ...
  for (const key of singularityUpgrades) {
    ...
    DOMCacheGetOrSet(`${String(key)}`).addEventListener("mouseover", () =>
      player.singularityUpgrades[`${String(key)}`].updateUpgradeHTML()
    );
    DOMCacheGetOrSet(`${String(key)}`).addEventListener("click", (event) =>
      player.singularityUpgrades[`${String(key)}`].buyLevel(event)
    );
  }
  ...
  for (const perk of singularityPerks) {
    ...
    perkHTML.innerHTML = `<img src="Pictures/${
      IconSets[player.iconSet][0]
    }/perk${perk.ID}.png">${perk.name()}`;
    perkHTML.id = perk.ID;
    ...
    DOMCacheGetOrSet(perk.ID).addEventListener("mouseover", () => {
      ...
      perkImage.src = `Pictures/${IconSets[player.iconSet][0]}/perk${
        perk.ID
      }.png`;
  ...
  for (const key of octeractUpgrades) {
    ...
    DOMCacheGetOrSet(`${String(key)}`).addEventListener("click", (event) =>
      player.octeractUpgrades[`${String(key)}`].buyLevel(event)
    );
  }
  ...
  for (const key of singularityChallenges) {
    ...
    DOMCacheGetOrSet(`${String(key)}`).addEventListener("click", () =>
  ...
  for (const key of blueberryUpgrades) {
    ...
    DOMCacheGetOrSet(`${String(key)}`).addEventListener("click", (event) =>
      player.blueberryUpgrades[`${String(key)}`].buyLevel(event)
    );
  }
  ...
  DOMCacheGetOrSet("blueberryToggleMode").addEventListener("click", () =>
    toggleBlueberryLoadoutmode()
  );

  DOMCacheGetOrSet("getBlueberries").addEventListener("click", () =>
    exportBlueberryTree()
  );
  DOMCacheGetOrSet("refundBlueberries").addEventListener("click", () =>
    resetBlueberryTree()
  );
  // Import blueberries
  DOMCacheGetOrSet("importBlueberries").addEventListener("change", async (e) =>
    importData(e, importBlueberryTree)
  );
