...
const antUpgradeTexts = [
  ...
  () => format(0.005 + 0.995 * 0.99 ** (player.antUpgrades[3 - 1]! + G.bonusant3), 4),
  () =>
  ...
  () => format(1 + (player.antUpgrades[6 - 1]! + G.bonusant6) ** 0.66, 4),
  () => format(Math.min(9999999, 3 * player.antUpgrades[7 - 1]! + 3 * G.bonusant7), 0, true),
  () => format(calculateSigmoidExponential(999, 1 / 10000 * (player.antUpgrades[8 - 1]! + G.bonusant8) ** 1.1), 3),
  () => format(1 * Math.min(1e7, player.antUpgrades[9 - 1]! + G.bonusant9), 0, true),
  () => format(1 + 2 * ((player.antUpgrades[10 - 1]! + G.bonusant10) / 50) ** 0.75, 4),
  () => format(1 + 2 * (1 - 2 ** (-(player.antUpgrades[11 - 1]! + G.bonusant11) / 125)), 4),
...
export const antSacrificePointsToMultiplier = (points: number) => {
  let multiplier = (1 + points / 5000) ** 2
