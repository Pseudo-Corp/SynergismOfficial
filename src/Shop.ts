  ...
  switch (input) {
    ...
    case 'offeringAuto':
      lol.innerHTML = i18next.t('shop.upgradeEffects.offeringAuto', {
        amount1: format(2 ** player.shopUpgrades.offeringAuto),
    ...
    case 'antSpeed':
      lol.innerHTML = i18next.t('shop.upgradeEffects.antSpeed', {
        amount: format(1.2 ** player.shopUpgrades.antSpeed, 2)
      })
      break
    case 'cashGrab':
    ...
    case 'offeringEX3':
      lol.innerHTML = i18next.t('shop.upgradeEffects.offeringEX3', {
        amount: format(100 * (1.02 ** player.shopUpgrades.offeringEX3 - 1), 2, true)
      })
      break
    case 'obtainiumEX3':
      lol.innerHTML = i18next.t('shop.upgradeEffects.obtainiumEX3', {
        amount: format(100 * (1.02 ** player.shopUpgrades.obtainiumEX3 - 1), 2, true)
      })
      break
    ...
    case 'seasonPassInfinity':
      lol.innerHTML = i18next.t('shop.upgradeEffects.seasonPassInfinity', {
        amount: format(100 * (1.02 ** player.shopUpgrades.seasonPassInfinity - 1), 2, true)
      })
      break
    case 'chronometerInfinity':
      lol.innerHTML = i18next.t('shop.upgradeEffects.chronometerInfinity', {
        amount: format(100 * (1.01 ** player.shopUpgrades.chronometerInfinity - 1), 2, true)
      })
      break
...
export const autoBuyConsumable = (input: ShopUpgradeNames) => {
  const maxBuyablePotions = Math.floor(
    Math.min(
      ...
      Math.min(shopData[input].maxLevel - player.shopUpgrades[input], player.highestSingularityCount ** 2 * 100)
    )
  )
